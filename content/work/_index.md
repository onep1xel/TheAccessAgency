...
- block: cards-2 #QLD guide comms and
  ...
  - heading: Ability Fest Social Takeover
    ...
    link:
      style: mint # whale mint sand
      text: Check out the social media project
      url: "work/ability-fest"


- block: work #Gold Coast
  background:  "#253148"
  color: light # light dark muted
  layout: horizontal # horizontal vertical
  offset: 20% # for horizontal layout set top spacing for text column in percentages eg 25%
...
- block: cards-2 #PV Video and CoM Video
  background: "#dededeff"
  color: dark # light dark muted
  padding: both
  cards:
  - heading: All Abilities Video Series
    ...
    link:
      style: whale # whale mint sand
      text: Check out the videos we produced
  ...
  - heading: Accessible Dining Video
    ...
    link:
      style: mint # whale mint sand
      text: Check out the video project
      url: "work/city-of-melbourne-accessible-dining-video"


- block: work # Visit Vic Mentoring
  background:  "#253148"
  color: light # light dark muted
  layout: horizontal # horizontal vertical
  offset: 20% # for horizontal layout set top spacing for text column in percentages eg 25%
